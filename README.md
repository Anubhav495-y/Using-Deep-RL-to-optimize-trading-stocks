...
As a practice problem before the main trading work, we have solved the classic **Inverted Pendulum** control task using a Deep Q-Network built from scratch instead of DDPG. The code is in [`pendulum_dqn/`](pendulum_dqn/), with a short write-up in [docs/Pendulum_DQN.md](docs/Pendulum_DQN.md).
